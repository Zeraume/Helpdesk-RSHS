...
<body>
    ...
    <div class="container mt-5">
        <div class="custom-tab p-1">
            <ul class="nav nav-tabs w-100 border-0" role="tablist">
                ...
                <li class="nav-item" role="presentation" style="flex: 1;">
                    <a class="nav-link fw-semibold text-center fw-semibold" id="tab-penyelesaian-tab"
    ...
    <!-- Tab Content -->
    <div class="tab-content container container-tabel rounded my-5 pt-2">
        ...
        <div class="tab-pane fade show active" id="tab-klasifikasi" role="tabpanel"
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="text-uppercase">
                                    <span class="editable-text">ETIK</span>
                                ...
                                <td>
                                    <div class="view-mode-actions">
                                        ...
                                        <a href="#" class="btn-inline-delete text-danger" title="Hapus"><i
                                                class="bi bi-trash"></i></a>
                                    </div>
                                    <div class="edit-mode-actions d-none">
                                        <a href="#" class="btn-inline-save text-success me-2" title="Simpan"><i
                            ...
                            <tr>
                                ...
                                <td class="text-uppercase">
                                    <span class="editable-text">SPONSORSHIP</span>
                                    <input type="text" class="form-control form-control-sm editable-input d-none"
                                        value="GRATIFIKASI">
                                </td>
                                <td><span class="badge bg-success">Aktif</span></td>
                                <td>
                                    <div class="view-mode-actions">
                                        ...
                                        <a href="#" class="btn-inline-delete text-danger"><i
                                                class="bi bi-trash"></i></a>
                                    </div>
                                    <div class="edit-mode-actions d-none">
                            ...
                            <tr>
                                ...
                                <td class="klasifikasi-cell text-uppercase">
                                    <span class="editable-text">GRATIFIKASI</span>
                                    <input type="text" class="form-control form-control-sm editable-input d-none"
                                        value="GRATIFIKASI">
                                </td>
                                <td><span class="badge bg-success">Aktif</span></td>
            ...
            <!-- Tabel 2 Klasifikasi Pengaduan & Jenis Media -->
                ...
                <div class="table-responsive">
                    <table class="table align-middle">
                        ...
                        <tbody>
                            <tr>
                                <td class="text-uppercase">
                                    <span class="editable-text">SMS HOTLINE</span>
                                    <input type="text" class="form-control form-control-sm editable-input d-none"
                                        value="SMS HOTLINE">
                                </td>
                            ...
                            <tr>
                                <td class="text-uppercase">
                                    <span class="editable-text">KOTAK SARAN</span>
                                    <input type="text" class="form-control form-control-sm editable-input d-none"
                                        value="KOTAK SARAN">
                                </td>
                                <td class="text-end"><span class="badge bg-success">Aktif</span></td>
                            ...
                            <tr>
                                <td class="text-uppercase">
                                    <span class="editable-text">EMAIL</span>
                                    <input type="text" class="form-control form-control-sm editable-input d-none"
                                        value="EMAIL">
                                </td>
                                <td class="text-end"><span class="badge bg-success">Aktif</span></td>
                            ...
                            <tr>
                                <td class="text-uppercase">
                                    <span class="editable-text">INSTAGRAM</span>
                                    <input type="text" class="form-control form-control-sm editable-input d-none"
                                        value="INSTAGRAM">
                                </td>
                                <td class="text-end"><span class="badge bg-success">Aktif</span></td>
                            ...
                            <tr>
                                <td class="text-uppercase">
                                    <span class="editable-text">HUMAS</span>
                                    <input type="text" class="form-control form-control-sm editable-input d-none"
                                        value="HUMAS">
                                </td>
                                <td class="text-end"><span class="badge bg-success">Aktif</span></td>
        ...
        <!-- Tabel 1 Penyelesaian Pengaduan & Jenis Laporan -->
